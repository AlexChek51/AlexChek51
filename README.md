...
- стажировка в комании ООО "Цифровые технологии". Реализовал проект на тему: "Использование искусственного интеллекта для формирования краткого обзора бизнес книг";
- разработал, реализовал несколько приложений на Python для обучения школьников и студентов;
- создал несколько телеграмм-ботов и нейро-сотрудников с искуственнм интелектом на борту;
