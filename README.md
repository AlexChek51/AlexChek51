...
Мой опыт начинался с инженерных задач, автоматизации и преподавания информатики. Преподавал Python и робототехнику, сопровождал учебные проекты. Изучал AI и участвовал в разработке ассистента для суммаризации бизнес-книг во время стажировки.

Работал в телекоммуникациях и промышленной автоматизации. В ранних ML- и учебных проектах использовал pandas, scikit-learn, PyTorch, TensorFlow / Keras, OpenCV, Hugging Face, Google Colab и CUDA.

Разрабатывал прикладное ПО на Python, JavaScript и C++ для Raspberry Pi под Debian, работал с оборудованием, платёжными модулями и сетевой инфраструктурой. Затем сосредоточился на fullstack-разработке, SaaS и AI-интеграциях. Параллельно выполнял отдельные коммерческие заказы и развивал собственные проекты.
